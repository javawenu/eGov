...
public class SewarageSearch implements Indexable {
	...
	@Searchable(name = "approvalnumber", group = Searchable.Group.SEARCHABLE)
	private String approvalNumber;
	
	@Searchable(name = "approvaldate", group = Searchable.Group.CLAUSES)
	...
	@Searchable(name = "dhscnumber", group = Searchable.Group.SEARCHABLE)
	...
	public void setDhscNumber(String dhscNumber) {
